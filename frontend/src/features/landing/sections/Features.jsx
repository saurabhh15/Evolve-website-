...
const FeatureCard = ({ feature }) => {
  return (
    ...
    >
      ...
      <div
        className="w-full md:w-[320px] lg:w-[380px] h-[180px] sm:h-[220px] md:h-auto shrink-0 flex flex-col items-center justify-center relative overflow-hidden p-5 sm:p-6 md:p-6"
      ...
      >
        ...
        <div className="w-full h-full rounded-[1.25rem] flex items-center justify-center relative overflow-hidden bg-white/5">
          <img
            src={feature.image}
            alt={feature.title}
    ...
    >
      ...
      <div className="relative" style={{ zIndex: 2 }}>
        <ScrollStack
          ...
          itemDistance={160} 
          itemScale={0.015}        // FIX: Subtler shrinking (stops card going back too much)
          itemStackDistance={32}  
          stackPosition="18%"     
          scaleEndPosition="10%"  
          baseScale={0.96}         // FIX: Gentle base scale keeps the stack prominent
          blurAmount={0}
        >
          {FEATURES.map((feature) => (
            <ScrollStackItem
              key={feature.tag}
              itemClassName="h-[460px] md:h-[480px]" // FIX: Strict height kills the "peeking bottom" bug entirely
              style={{
                background: feature.cardBg,
