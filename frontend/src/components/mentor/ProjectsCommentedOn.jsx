    ...
    <div className="relative bg-[#080808] border border-white/[0.03] overflow-hidden group">
      ...
      <div className="p-8 flex flex-col relative z-10">
        ...
        <div className="flex items-center gap-5 mb-10">
          ...
          <div>
            <h2 className="text-[14px] font-black text-white uppercase tracking-[0.4em] italic">Projects I Reviewed</h2>
        ...
        <div className="space-y-6">
          {loading ? (
            ...
            <div
              ...
              className="relative group/item bg-transparent border-l border-white/5 hover:border-[#e87315] pl-6 py-2 transition-all duration-500 cursor-pointer"
            >
              <div className="flex items-start gap-6">
                ...
                <div className="relative shrink-0">
                  {project.images?.[0] ? (
                    <img
                      ...
                      className="w-14 h-14 rounded-none object-cover grayscale group-hover/item:grayscale-0 transition-all duration-500 border border-white/10"
                      alt={project.title}
                    />
                  ) : (
                    <div className="w-14 h-14 bg-[#080808] border border-white/5 flex items-center justify-center">
                      <span className="text-[#e87315] font-black text-lg">E</span>
                    </div>
                  )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="text-[11px] font-black text-white uppercase tracking-widest group-hover/item:text-[#e87315] transition-colors truncate">
                      {project.title}
                    </h3>
                  </div>

                  <p className="text-[9px] font-bold text-white/20 uppercase tracking-tighter truncate mb-3">
                    {project.tagline}
                  </p>

                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4 opacity-40 group-hover/item:opacity-100 transition-opacity">
                      <div className="flex items-center gap-1.5">
                        <Eye size={10} className="text-white" />
                        <span className="text-[9px] font-mono text-white">{project.viewCount || 0}</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <Heart size={10} className="text-white" />
                        <span className="text-[9px] font-mono text-white">{project.likes?.length || 0}</span>
                      </div>
                    </div>

                    <span className="text-[8px] font-black text-[#e87315] uppercase tracking-widest px-2 py-1 bg-[#e87315]/5 border border-[#e87315]/20">
                  ...
                  {project.latestComment?.content && (
                    <div className="relative">
                      ...
                      <p className="text-[10px] text-white/40 italic leading-relaxed pl-4 line-clamp-1">
                        "{project.latestComment.content}"
                      </p>
                    </div>
                  )}
            ...
            <div className="flex flex-col items-center justify-center py-20 border border-dashed border-white/5">
              ...
              <h3 className="text-[10px] font-black text-white/20 uppercase tracking-[0.5em]">No reviews yet</h3>
              <p className="text-[9px] font-bold text-white/10 uppercase tracking-widest mt-2 italic">Projects you comment on will appear here</p>
            </div>
          )}
        </div>
      </div>
