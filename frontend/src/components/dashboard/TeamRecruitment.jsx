...
const TeamRecruitment = () => {
  ...
  return (
    <div className="card-structured p-4 sm:p-6 md:p-8 h-full flex flex-col border border-dashed border-white/10">

      {/* Summary Stats */}
      <div className="grid grid-cols-2 gap-0 mb-6 sm:mb-10 pb-6 sm:pb-8 border-b border-white/5 relative">
        {/* Open Roles */}
        <div className="relative p-4 sm:p-6 border-r border-white/5 group">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2 mb-1 sm:mb-2">
              ...
              <p className="text-[8px] sm:text-[9px] font-black text-white/20 uppercase tracking-[0.2em] sm:tracking-[0.3em]">Open Roles</p>
            </div>
            <p className="text-2xl sm:text-4xl font-light text-white tabular-nums tracking-tighter">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-center justify-between mb-1 sm:mb-2 flex-wrap gap-1">
              <div className="flex items-center gap-2">
                <div className="w-1 h-1 bg-[#e87315]/40" />
                <p className="text-[8px] sm:text-[9px] font-black text-white/20 uppercase tracking-[0.2em] sm:tracking-[0.3em]">Applicants</p>
              </div>
              {totalApplicants > 0 && (
                <div className="flex items-center gap-2">
      ...
      {/* Open Roles List */}
      <div className="flex-1 space-y-2 overflow-y-auto pr-1 sm:pr-2 custom-scrollbar">
        {loading ? (
          [1, 2, 3].map(i => (
          ...
          <div
            ...
            className="group relative bg-[#080808] border border-white/[0.03] hover:border-white/10 transition-all duration-500 cursor-pointer p-3 sm:p-4 overflow-hidden"
          >
            ...
            <div className="flex flex-row items-center justify-between gap-3 sm:gap-4 relative z-10">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-[8px] sm:text-[10px] font-black text-[#e87315] opacity-40 italic group-hover:opacity-100 transition-opacity shrink-0">
                    {index.toString().padStart(2, '0')}
                  </span>
                  <h3 className="text-[11px] sm:text-[13px] font-black text-white group-hover:text-[#e87315] transition-colors uppercase tracking-tight truncate">
                    {role.role}
                  </h3>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-white/10 shrink-0" />
                  <p className="text-[8px] sm:text-[9px] text-white/20 font-bold uppercase tracking-[0.2em] truncate">
              ...
              <div className="flex-shrink-0">
                {role.applicants > 0 ? (
                  <div className="flex items-center gap-2 sm:gap-3 px-3 py-1.5 sm:px-4 sm:py-2 border border-[#e87315]/20 group-hover:bg-[#e87315]/[0.02] transition-all">
                    <div className="relative shrink-0">
                      <UserPlus size={10} className="text-[#e87315] sm:w-3 sm:h-3" />
                    ...
                    <div className="flex flex-col items-start leading-none">
                      ...
                      <span className="text-[5px] sm:text-[6px] font-black text-[#e87315] uppercase tracking-widest hidden sm:block">
                        Pending
                      </span>
                    </div>
                  </div>
          ...
          <div className="text-center py-12 sm:py-16 border border-dashed border-white/10 relative group mx-1">
            ...
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-transparent border border-white/5 flex items-center justify-center mx-auto mb-4 sm:mb-6 relative">
              <Users size={18} className="text-white/10 group-hover:text-[#e87315] transition-colors" />
              <div className="absolute -top-1 -left-1 w-2 h-2 border-t border-l border-white/10" />
            </div>
            <h3 className="text-[9px] sm:text-[10px] font-black text-white uppercase tracking-[0.5em] mb-2 italic">No open roles</h3>
      ...
      {hasMoreProjects && (
        <p className="text-[8px] sm:text-[9px] font-bold text-white/20 uppercase tracking-widest text-center py-2">
      ...
      <button
        ...
        className="relative w-full mt-2 sm:mt-1 group/cmd overflow-hidden transition-all duration-500"
      >
        <div className="absolute inset-0 bg-[#e87315]/[0.02] group-hover/cmd:bg-[#e87315]/[0.06] transition-colors duration-500" />
        <div className="relative flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border border-white/5 group-hover/cmd:border-[#e87315]/30 transition-all duration-500">
          <div className="absolute top-0 left-0 w-1 h-1 bg-white/10 group-hover/cmd:bg-[#e87315] transition-colors" />
          <div className="flex flex-col items-start gap-1">
            <span className="text-[7px] sm:text-[8px] font-black text-[#e87315] uppercase tracking-[0.4em] opacity-0 group-hover/cmd:opacity-100 transition-all duration-500 translate-y-2 group-hover/cmd:translate-y-0">
              Execute
            </span>
            <span className="text-[9px] sm:text-[11px] font-black text-white uppercase tracking-[0.2em]">
              Manage Project
            </span>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="h-[1px] w-4 sm:w-4 bg-white/10 group-hover/cmd:w-8 group-hover/cmd:bg-[#e87315]/50 transition-all duration-700" />
            <ChevronRight size={14} className="text-white/20 sm:w-4 sm:h-4 group-hover/cmd:text-[#e87315] group-hover/cmd:translate-x-1 transition-all duration-500" />
          </div>
        </div>
