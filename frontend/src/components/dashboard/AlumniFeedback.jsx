...
const AlumniFeedback = () => {
  ...
  return (
    <div className="card-structured p-8 h-full flex flex-col border border-white/[0.02]">
      {/* Header */}
      ...
      <div className="flex-1 space-y-4 overflow-y-auto pr-2">
        {loading ? (
          ...
          <div
            key={comment._id}
            className="group relative bg-[#080808] p-6 border border-white/[0.03] hover:border-white/10 transition-all duration-500 overflow-hidden"
          >
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  <img
                    ...
                    className="w-12 h-12 grayscale group-hover/avatar:grayscale-0 border border-white/10 transition-all duration-500"
                  />
                  ...
                  {comment.author?.role === 'Mentor' && (
                    <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-[#e87315] flex items-center justify-center border border-[#080808]">
                ...
                <div className="space-y-1">
                  <h3
                    className="text-[13px] font-black text-white uppercase tracking-tight cursor-pointer hover:text-[#e87315] transition-colors"
                    onClick={() => navigate(`/dashboard/user/${comment.author?._id}`)}
                  >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className="text-[10px] text-white/30 font-bold uppercase tracking-widest cursor-pointer hover:text-white transition-colors"
...
`}>
                ...
                <button
                  ...
                  className="p-2 opacity-0 group-hover:opacity-100 hover:bg-red-500/10 text-white/20 hover:text-red-500 transition-all border border-transparent hover:border-red-500/20"
                >
                  <Trash2 size={12} />
                </button>
              </div>
            ...
            <div className="flex items-center justify-between opacity-30">
              <div className="flex items-center gap-2">
                <Clock size={10} />
                <span className="text-[9px] font-black uppercase tracking-[0.3em] tabular-nums">
          ...
          <div className="relative flex flex-col items-center justify-center py-24 px-6 border border-dashed border-white/10 bg-transparent overflow-hidden group">
            {/* ── Background Decal ── */}


            {/* ── Icon Node (Geometric Frame) ── */}
            <div className="relative mb-8">
              <div className="w-16 h-16 bg-transparent border border-white/5 flex items-center justify-center transition-all duration-700 group-hover:bg-[#e87315]/[0.03] group-hover:border-[#e87315]/20">
            ...
            <div className="text-center space-y-4 relative z-10">
              <div className="flex items-center justify-center gap-4">
                ...
                <h3 className="text-[11px] font-black text-white uppercase tracking-[0.6em] italic">
              ...
              <div className="space-y-1">
                <p className="text-[9px] font-bold text-[#e87315]/60 uppercase tracking-[0.2em]">
      ...
      {comments.length > 0 && (
        <button
          ...
          className="relative w-full mt-8 group/cmd overflow-hidden transition-all duration-500"
        >
          {/* ── Structural Frame ── */}
          <div className="relative flex items-center justify-center gap-3 px-6 py-4 bg-transparent border border-white/10 group-hover/cmd:border-[#e87315]/40 transition-all duration-500">
            ...
            {/* The Label */}
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black text-white/20 group-hover/cmd:text-[#e87315]/60 transition-colors uppercase tracking-[0.3em]">
                View all project
              </span>
