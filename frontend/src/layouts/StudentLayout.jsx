...
const StudentLayout = ({ children, setActiveTab, activeTab }) => {
  const { user } = useAuth();
  ...
  const navItems = [
    ...
    { name: "Find Mentors", path: "/dashboard/mentors", icon: GraduationCap },
    {
      name: "Inbox",
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden">
      ...
      {/* Top Navigation Bar - Replicating the center nav structure */}
      <nav className="sticky top-0 z-50 bg-[#080808]/80 backdrop-blur-xl border-b border-white/[0.03]">
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          {/* Center: Desktop Navigation - Replicating the specific pill structure */}
              ...
              return (
                ...
                >
                  ...
                  {item.name === "Inbox" && unreadMessages > 0 && (
                    <span
                      className={`ml-1 w-1 h-1 rounded-none rotate-45 animate-pulse ${isActive ? "bg-black" : "bg-[#e87315]"}`}
                    />
                  )}
          ...
          <div className="flex items-center gap-4">
                  ...
                  <div className="absolute right-0 top-14 w-80 bg-[#101010] border border-white/[0.06] rounded-2xl shadow-2xl z-50 overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-6 py-5 border-b border-white/5 bg-white/[0.01]">
                      <div className="flex items-center gap-3">
                        ...
                        <div
                          className={`w-1.5 h-1.5 rotate-45 ${unreadCount > 0 ? "bg-[#e87315] shadow-[0_0_8px_#e87315]" : "bg-white/10"}`}
                        />
                      ...
                      {notifLoading ? (
                        ...
                        <>
                          ...
                          {notifications.requests?.map((req) => (
                            <div
                              key={req._id}
                              className="group px-6 py-5 border-b border-white/5 hover:bg-white/[0.01] transition-all relative"
                            >
                              ...
                              <div className="flex items-start gap-4">
                                <div className="relative flex-shrink-0">
                                  <img
                                    ...
                                    onError={(e) => {
                                      e.target.src = `https://ui-avatars.com/api/?background=080808&color=e87315&size=100&name=${req.from?.name}&bold=true`;
                                    }}
                          ...
                          {notifications.notifs?.map((notif) => (
                            <div
                              ...
                              onClick={() => {
                                ...
                                if (notif.project)
                                  navigate(
                                    `/dashboard/project/${notif.project._id}`,
                                  );
                              }}
                            ...
                            >
                              ...
                              <div className="flex items-start gap-4">
                                <img
                                  ...
                                  onError={(e) => {
                                    e.target.src = `https://ui-avatars.com/api/?background=080808&color=e87315&size=100&name=${notif.sender?.name}&bold=true`;
                                  }}
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <span className="text-white/10 group-hover:text-[#e87315]/40 transition-colors duration-500 font-light">
                          [
                        </span>
            ...
            <Link
              ...
              className="flex items-center gap-4 bg-transparent group border-l border-white/5 hover:border-[#e87315] transition-all duration-500"
            >
                ...
                >
                  ...
                  <item.icon
                    ...
                    className={`transition-colors duration-300 ${
                      isActive
                        ? "text-black"
                        : "text-[#e87315]/40 group-hover:text-[#e87315]"
                    }`}
                    strokeWidth={isActive ? 3 : 2}
                  />
                  ...
                  {item.name === "Inbox" && unreadMessages > 0 && (
                    <div className="ml-auto flex items-center gap-2">
                      ...
                      <span
                        className={`w-1.5 h-1.5 rotate-45 ${isActive ? "bg-black" : "bg-[#e87315] animate-pulse"}`}
                      />
                    </div>
                  )}
              ...
              {connectionsLoading ? (
                <div className="p-6 space-y-4">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-14 bg-white/[0.02] border border-white/5 animate-pulse"
                    />
                  ))}
                </div>
              ) : networkTab === "accepted" ? (
                connections.filter((c) => {
                  ...
                  const matchesFilter =
                    ...
                    c.role?.toLowerCase() === connectionFilter.toLowerCase();
                    ...
                    .map((connection) => (
                        ...
                        onClick={() => {
                          navigate(
                            connection.role?.toLowerCase() === "mentor"
                              ? `/dashboard/mentor/${connection._id}`
                              : `/dashboard/user/${connection._id}`,
                          );
                      ...
                      >
                        ...
                        <img
                          ...
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?background=080808&color=e87315&size=100&name=${encodeURIComponent(connection.name || "U")}&bold=true`;
                          }}
                    ...
                    filtered.map((conn) => (
                      ...
                      >
                        ...
                        <img
                          ...
                          onError={(e) => {
                            e.target.src = `https://ui-avatars.com/api/?background=080808&color=e87315&size=100&name=${encodeURIComponent(conn.from?.name || "U")}&bold=true`;
                          }}
                          className="w-11 h-11 object-cover border border-white/10 grayscale group-hover:grayscale-0 transition-all duration-500"
                          alt={conn.from?.name}
                        />
                        ...
                        <div className="flex flex-col gap-1.5 shrink-0">
                          <button
                            onClick={async (e) => {
                              e.stopPropagation();
                              await connectionAPI.updateStatus(
                                conn._id,
                                "accepted",
                              );
                              setPendingConnections((prev) =>
                                prev.filter((c) => c._id !== conn._id),
                              );
                              window.dispatchEvent(
                                new CustomEvent("connection_actioned", {
                                  detail: { id: conn._id },
