...
const EventPage = () => {
    ...
    return (
        <div className="bg-[#fffaf5] min-h-screen text-black relative p-6 md:p-12">
            {user && (
                <div>
                    <button
                        ...
                        className="pointer-events-auto flex items-center gap-2 text-[19px] font-bold tracking-widest uppercase text-black/80 hover:text-[#e87315] transition-colors  backdrop-blur-md border border-white/[0.06] "
                    >
                        <ArrowLeft size={16} />
                        Back
                    </button>
            ...
            <div className="relative group overflow-hidden bg-[#080808] border border-white/[0.03] min-h-[400px] flex flex-col items-center justify-center p-12 text-center transition-all duration-500 hover:border-[#e87315]/20">
                ...
                <div className="relative mb-8">
                    ...
                    <div className="relative w-20 h-20 border border-white/10 flex items-center justify-center rotate-45 group-hover:border-[#e87315]/40 transition-colors duration-500">
                        <CalendarOff
                            size={32}
                            className="text-white/10 -rotate-45 group-hover:text-[#e87315] transition-colors duration-500"
                        />
                    </div>
                </div>
                ...
                <div className="relative z-10 max-w-md">
                    <h3 className="text-[14px] font-black tracking-[0.6em] uppercase text-white mb-4 italic">
                        No Upcoming Events yet
                    </h3>

                    <div className="flex items-center justify-center gap-3 mb-6">
                        <div className="h-px w-8 bg-[#e87315]/30" />
                        <p className="text-[11px] font-bold text-[#e87315] uppercase tracking-[0.2em]">
                    ...
                    {/* Coming Soon Badge */}
                    <div className="inline-flex items-center gap-3 px-6 py-2 bg-white/[0.02] border border-white/5 rounded-full group-hover:border-[#e87315]/20 transition-all">
