...
import { Heart, Eye, Users, ArrowLeft, ExternalLink, Send, Pencil, Trash2, Sparkles, Loader2, X, Zap, MapPin, Star, Github } from 'lucide-react';
                ...
                <aside className="lg:col-span-4 h-fit space-y-4 sm:space-y-6">
                    ...
                    <div className="relative bg-[#0c0c0c] p-6 sm:p-8 border border-white/10 group overflow-hidden">
                        ...
                        <div className="flex gap-3 mb-6 sm:mb-8">
                            ...
                            {project.githubUrl && (
                                <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 py-3 sm:py-3.5 border border-white/10 bg-white/[0.05] text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] text-white/60 hover:text-white hover:border-white/30 transition-all">
