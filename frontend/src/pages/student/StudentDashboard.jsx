    ...
    <div className="w-full space-y-8 px-4 md:px-8 pb-10">
      ...
      >
        ...
        <div className="relative z-10 w-full md:w-3/5 space-y-6">
          <div>
            <p className="text-[#e87315]/80 text-[11px] sm:text-xs font-black tracking-[0.3em] uppercase mb-3 sm:mb-4">Welcome Back</p>
        ...
        <div className="relative z-10 hidden md:flex w-full md:w-2/5 justify-end mt-8 md:mt-0">
          ...
          <div className="relative w-64 h-52 [transform:perspective(1000px)_rotateX(10deg)_rotateY(-15deg)] hover:[transform:perspective(1000px)_rotateX(5deg)_rotateY(-5deg)] transition-transform duration-700 ease-out group cursor-default">
              ...
              <div className="space-y-3.5 w-full relative z-10">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] sm:text-[11px] font-bold text-white/60 uppercase tracking-widest">Mentors</span>
                  </div>
                  <span className="text-[10px] sm:text-[11px] font-black text-white/90">{mentorsCount}</span>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-9 gap-8 items-start">
        ...
        <div className="animate-evolve-in lg:col-span-3" style={{ animationDelay: '0.28s' }}>
          <Eventscard />
        </div>
      </div>
